...
<anime>
  ...
  describe("error handling", () => {
    ...
    test("searchAnime throws on AniDB error XML", async () => {
...
<error code="310">illegal input or access denied</error>`;
    ...
    test("getEpisodes throws on AniDB error XML", async () => {
      const errorXml = `<?xml version="1.0" encoding="UTF-8"?>
<error code="500">Banned</error>`;
    ...
    test("getAnime throws on AniDB error XML", async () => {
      const errorXml = `<?xml version="1.0" encoding="UTF-8"?>
<error code="310">illegal input or access denied</error>`;
      const plugin = new AniDBPlugin({
        client: "kogoro",
    ...
    test("getArtwork throws on AniDB error XML", async () => {
      const errorXml = `<?xml version="1.0" encoding="UTF-8"?>
<error code="320">no such anime</error>`;
    ...
    test("uses unknown code when error has no code attribute", async () => {
      const errorXml = `<?xml version="1.0" encoding="UTF-8"?>
